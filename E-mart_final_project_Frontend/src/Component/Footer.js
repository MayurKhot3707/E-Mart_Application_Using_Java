...
<div className="container-fluid justify-content-center p-0 mx-0">
  <hr/>
    <div className="card py-5 border-0 px-0 mx-0">
        <div className="card-body text-center">
            <div className="row  justify-content-center">
                <div className="col-auto"><h6><b>Still have more questions ?</b></h6><small className="text-muted">Call/Text <span className="mx-2"><b>+91.1630.412.999</b></span>and with real person.</small>
                    <div className="row justify-content-center">
                      <div className="col-10">
                        <button type="button" className="btn btn-primary btn-lg btn-block my-5">Try it for free</button>
                        <h6> <b>100% Money Back Guarantee</b></h6> 
                        <small className="text-muted">If you'r not satsified for any reason, we'll refund your money</small>
                      </div>
                    </div>
                </div>
            </div>
